...
export class StatsController {
  ...
  @ApiResponse({
    status: 200,
    description:
      'ყოველდღიური ხმების რაოდენობა, პიკური საათი და ტრენდის მიმართულება',
  })
  ...
  @ApiResponse({
    status: 200,
    description:
      'ხმების რაოდენობა სქესის (male/female/unknown) და ასაკობრივი ჯგუფების მიხედვით',
  })
  getDemographics() {
  ...
  @ApiResponse({
    status: 200,
    description:
      'კითხვის ხმების განაწილება სქესისა და ასაკობრივი ჯგუფების მიხედვით, დეტალურად თითოეულ პასუხზეც',
  })
